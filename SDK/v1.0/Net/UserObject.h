...
public:
	...
	bool	SendZipMsg(PHEADER pMsg, bool bAsyncSend = true);
public:
	bool	ZipMsg(PHEADER pMsg, CBuffer* pBuffer);	
	bool	UnZipMsg(PHEADER pMsg,	CBuffer* pBuffer);
private:
	
public:
	time_t				m_tBreak;
	time_t				m_tConnection;
public:
	unsigned int		m_dwIP;
	int					m_nPort;
private:
