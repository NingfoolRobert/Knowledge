...
void CBufferMgr::PrintInfo(CBuffer* pBuf)
{
	...
	sprintf(szBuf,"BufferMgr Cnt: %ld/%ld/%ld/%ld/%ld/%ld/%ld/%ld.", m_listBuf[0].size(), m_listBuf[1].size(), m_listBuf[2].size(), m_listBuf[3].size(), m_listBuf[4].size(), m_listBuf[5].size(), m_listBuf[6].size(), m_listBuf[7].size());
